...
<div id="todo" class="uk-form">
    ...
    <button class="uk-button uk-button-primary uk-align-right" v-on="click: save">{{ 'Save' | trans }}</button>
    ...
    <ul class="uk-list uk-list-line" v-if="entries.length">
        <li class="uk-text-large" v-repeat="entry: entries" v-class="uk-text-muted: entry.done">
